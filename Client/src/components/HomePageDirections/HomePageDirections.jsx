...
import './HomePageDirections.css'
 ...
 const HomePageDirections = (props) => {
  return (
      <div className="HomePageDirections sm:w-full md:flex-row">

      <div className="img-text-container">
    <img className="home-directions-img  w-full md:-w-50%" alt="A park" src={props.image}/>
    <div className="home-page-directions-text md:w-full h-full">
        ...
        <button className="home-directions-button"><Link to="/Search">Start here</Link></button>
    </div>
